...
static inline int crypto_core_chacha20_neon(unsigned char *out, unsigned char *in){
  ...
  TR = vtrnq_u64(vreinterpretq_u64_u32(D.val[0]),vreinterpretq_u64_u32(D.val[2]));
  DD.val[0] = vreinterpretq_u32_u64(TR[0]); DD.val[2] = vreinterpretq_u32_u64(TR[1]);
  TR = vtrnq(vreinterpretq_u64_u32(D.val[1]),vreinterpretq_u64_u32(D.val[3]));
  DD.val[1] = vreinterpretq_u32_u64(TR[0]); DD.val[3] = vreinterpretq_u32_u64(TR[1]);
  TS = vtrnq_u32(D.val[0],D.val[1]);
  DD.val[0] = TS[0]; DD.val[1] = TS[1];
  TS = vtrnq_u32(D.val[2],D.val[3]);
  DD.val[2] = TS[0]; DD.val[2] = TS[1];
...
DD.val[2] = vreinterpretq_u32_u16(vrev32q_u16(vreinterpretq_u16_u32(D.val[2])));
  ...
  TR = vtrnq_u64(vreinterpretq_u64_u32(A.val[0]),vreinterpretq_u64_u32(A.val[2]));
  TR = vtrnq_u64(vreinterpretq_u64_u32(B.val[0]),vreinterpretq_u64_u32(B.val[2]));
  TR = vtrnq_u64(vreinterpretq_u64_u32(C.val[0]),vreinterpretq_u64_u32(C.val[2]));
  AA.val[0] = vreinterpretq_u32_u64(TR[0]); AA.val[2] = vreinterpretq_u32_u64(TR[1]);
  BB.val[0] = vreinterpretq_u32_u64(TR[0]); BB.val[2] = vreinterpretq_u32_u64(TR[1]);
  CC.val[0] = vreinterpretq_u32_u64(TR[0]); CC.val[2] = vreinterpretq_u32_u64(TR[1]);
  TR = vtrnq(vreinterpretq_u64_u32(A.val[1]),vreinterpretq_u64_u32(A.val[3]));
  TR = vtrnq(vreinterpretq_u64_u32(B.val[1]),vreinterpretq_u64_u32(B.val[3]));
  TR = vtrnq(vreinterpretq_u64_u32(C.val[1]),vreinterpretq_u64_u32(C.val[3]));
  AA.val[1] = vreinterpretq_u32_u64(TR[0]); AA.val[3] = vreinterpretq_u32_u64(TR[1]);
  BB.val[1] = vreinterpretq_u32_u64(TR[0]); BB.val[3] = vreinterpretq_u32_u64(TR[1]);
  CC.val[1] = vreinterpretq_u32_u64(TR[0]); CC.val[3] = vreinterpretq_u32_u64(TR[1]);
  TS = vtrnq_u32(A.val[0],A.val[1]);
  TS = vtrnq_u32(B.val[0],B.val[1]);
  TS = vtrnq_u32(C.val[0],C.val[1]);
  AA.val[0] = TS[0]; AA.val[1] = TS[1];
  BB.val[0] = TS[0]; BB.val[1] = TS[1];
  CC.val[0] = TS[0]; CC.val[1] = TS[1];
  TS = vtrnq_u32(A.val[2],A.val[3]);
  TS = vtrnq_u32(B.val[2],B.val[3]);
  TS = vtrnq_u32(C.val[2],C.val[3]);
  AA.val[2] = TS[0]; AA.val[2] = TS[1];
  BB.val[2] = TS[0]; BB.val[2] = TS[1];
  CC.val[2] = TS[0]; CC.val[2] = TS[1];
