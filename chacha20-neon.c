...
static inline int crypto_core_chacha20_neon(unsigned char *out, unsigned char *in){
  ...
  for (i=ROUNDS/2; i>0; i--) {
    ...
    DD.val[0]= vshlq_n_u32( D.val[0], 16);
    DD.val[1]= vshlq_n_u32( D.val[1], 16);
    DD.val[2]= vshlq_n_u32( D.val[2], 16);
    DD.val[3]= vshlq_n_u32( D.val[3], 16);
    DD.val[0]= vsraq_n_u32(DD.val[0], D.val[0], 16);
    DD.val[1]= vsraq_n_u32(DD.val[1], D.val[1], 16);
    DD.val[2]= vsraq_n_u32(DD.val[2], D.val[2], 16);
    DD.val[3]= vsraq_n_u32(DD.val[3], D.val[3], 16);
    ...
    D.val[0] = vshlq_n_u32(DD.val[0], 8);
    D.val[1] = vshlq_n_u32(DD.val[1], 8);
    D.val[2] = vshlq_n_u32(DD.val[2], 8);
    D.val[3] = vshlq_n_u32(DD.val[3], 8);
    D.val[0] = vsraq_n_u32( D.val[0],DD.val[0], 24);
    D.val[1] = vsraq_n_u32( D.val[1],DD.val[1], 24);
    D.val[2] = vsraq_n_u32( D.val[2],DD.val[2], 24);
    D.val[3] = vsraq_n_u32( D.val[3],DD.val[3], 24);
