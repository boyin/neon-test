...
static inline int crypto_core_chacha20_neon(unsigned char *out, unsigned char *in){
  uint32x4_t A0, B0, C0, D0, A1, B1, C1, D1, A2, B2, C2, D2, A3, B3, C3, D3;
  ...
  for (i=ROUNDS/2; i>0; i--) {
    ...
    A0 = vaddq_u32(A0, B0); A1 = vaddq_u32(A1, B1);
    A2 = vaddq_u32(A2, B2); A3 = vaddq_u32(A3, B3);
    D0 = veorq_u32(D0, A0); D1 = veorq_u32(D1, A1);
    D2 = veorq_u32(D2, A2); D3 = veorq_u32(D3, A3);
    E0 = vshlq_n_u32(D0, 16);
    E1 = vshlq_n_u32(D1, 16);
    E2 = vshlq_n_u32(D2, 16); 
    E3 = vshlq_n_u32(D3, 16); 
    D0 = vsraq_n_u32(E0, D0, 16);
    D1 = vsraq_n_u32(E1, D1, 16);
    D2 = vsraq_n_u32(E2, D2, 16);
    D3 = vsraq_n_u32(E3, D3, 16);
    
    C0 = vaddq_u32(C0, D0); C1 = vaddq_u32(C1, D1);
    C2 = vaddq_u32(C2, D2); C3 = vaddq_u32(C3, D3);
    B0 = veorq_u32(B0, C0); B1 = veorq_u32(B1, C1);
    B2 = veorq_u32(B2, C2); B3 = veorq_u32(B3, C3);
    E0 = vshlq_n_u32(B0, 12);
    E1 = vshlq_n_u32(B1, 12);
    E2 = vshlq_n_u32(B2, 12); 
    E3 = vshlq_n_u32(B3, 12); 
    B0 = vsraq_n_u32(E0, B0, 20);
    B1 = vsraq_n_u32(E1, B1, 20);
    B2 = vsraq_n_u32(E2, B2, 20);
    B3 = vsraq_n_u32(E3, B3, 20);
